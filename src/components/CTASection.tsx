  ...
  return (
    <section className="py-24 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto">
        <FadeInSection>
          <div className="bg-gradient-to-br from-[#F6F6F8] to-[#EEF2FF] border border-[#3B82F6]/20 rounded-3xl p-10 sm:p-14 text-center">
            <div className="mb-6">
            ...
            <p className="text-[#18181B]/50 text-base sm:text-lg mb-8">
              규모·예산·일정 — 상황 맞는 운영안을 빠르게 정리해드립니다.
            </p>

            {/* 문의 팁 */}
            <div className="bg-[#FFFFFF]/60 border border-[#E4E4E7] rounded-2xl p-5 mb-8 text-left">
              <p className="text-xs font-semibold text-[#3B82F6] uppercase tracking-wider mb-4">
                💡 문의 시 이런 내용을 적어주시면 더 빨라요
              </p>
              <div className="space-y-3">
                {inquiryTips.map((t) => (
                  <div key={t.text} className="flex items-center gap-3 text-sm text-[#18181B]/70">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <motion.a
                ...
                className="inline-flex items-center justify-center gap-2 border border-[#E4E4E7] hover:border-[#3B82F6] text-[#18181B]/80 hover:text-[#18181B] font-semibold px-8 py-4 rounded-xl transition-all text-base"
              >
                📞 지금 바로 전화하기
              </motion.a>
            </div>
