...
export const metadata: Metadata = {
  ...
  keywords: [
    "AI교육", "AX교육", "AI전환교육",
    "부산AI교육", "부산AX교육", "부산인공지능교육",
    "울산AI교육", "울산AX교육", "경남AI교육",
    "부울경AI교육", "부산기업AI교육", "부산공공기관AI교육",
    "AI업무자동화", "ChatGPT교육", "Claude교육",
    "AI챗봇구축", "AI콘텐츠자동화", "부산AI랩",
    "AI출강", "기업맞춤AI교육", "공공기관AI교육",
    "부산AI코딩스쿨", "재직자AI교육", "직원AI교육",
  ],
