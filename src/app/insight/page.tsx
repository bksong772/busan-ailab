    ...
    <>
      ...
      <main className="min-h-screen bg-[#FFFFFF] pt-24 pb-20">
        ...
        <section className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <h1 className="mt-5 text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[#18181B] break-keep">
            AX 전환 현장에서
            <br />
          ...
          <p className="mt-5 max-w-2xl text-base sm:text-lg text-[#18181B]/60 leading-7 break-keep">
                ...
                >
                  <div className="flex flex-wrap items-center gap-2">
                    {it.tags.slice(0, 3).map((t) => (
                      <span
                        key={t}
                        className="rounded-full border border-[#E4E4E7] bg-[#FFFFFF] px-3 py-1 text-[11px] font-semibold text-[#18181B]/60"
                      >
                        #{t}
                      </span>
                    ))}
                  ...
                  <h2 className="mt-4 text-lg sm:text-xl font-extrabold text-[#18181B] leading-snug break-keep group-hover:text-[#93C5FD] transition-colors">
                    {it.title}
                  </h2>

                  <p className="mt-3 text-sm leading-6 text-[#18181B]/60 line-clamp-3 break-keep">
                    {it.summary}
                  </p>

                  <div className="mt-5 flex items-center justify-between text-xs text-[#18181B]/40">
